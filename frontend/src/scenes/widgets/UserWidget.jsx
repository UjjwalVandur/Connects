...
const UserWidget = ({ userId, picturePath, isOwnProfile }) => {
  ...
  // Determine if this component is rendering for the logged-in user
  // isOwnProfile prop takes priority (set by ProfilePage); fallback to ID match
  ...
  return (
    <WidgetWrapper>
      ...
      >
        ...
        {/* Only show manage icon for own profile */}
      ...
      {/* FOURTH ROW — Social (edit only for own profile) */}
      <Box p="1rem 0">
        ...
        <FlexBetween gap="1rem" mb="0.5rem">
          ...
          {canEdit && <EditOutlined sx={{ color: main }} />}
        </FlexBetween>
